...
網路上目前都有很多的範例，包含在各個平台的應用，還有Python上結合OpenCV進行實際上的應用，，使用的環境是windows+webform，最終目標是希望透過WebServices把圖片的Stream傳送到Server，然後Server再將結果回傳。


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxMTY4Nzc2LDE5MDQ1NjU4ODddfQ==
-->